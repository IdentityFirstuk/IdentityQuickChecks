...
if (-not $Password) {
    $Password = Read-Host "Enter PFX password (hidden)" -AsSecureString
}
...
try {
    ...
    Write-Host "        Ensure the PFX path and password are correct." -ForegroundColor Gray
    exit 1
}
...
Write-Host "[OK] Certificate added to Local Machine Trusted People store" -ForegroundColor Green
...
Write-Host "[OK] Certificate added to Current User Trusted People store" -ForegroundColor Green
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB4espWAF2YjMhO
# c4P/s3iTg8I6bb/NqWycIDBRHsdXbqCCFlgwggMaMIICAqADAgECAhBf+irPCn8a
...
# DAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgf7ZpaRq/KjUvfi/i46M6hikw
# BX46HVphG1E/lRNCszQwDQYJKoZIhvcNAQEBBQAEggEAJuPSpf1QsV9CZ+fWQoiS
# zFmtuC8lSIF6JifMvC4GoskPHLtLu2lo7Y/Dh0iObhSl1VLypZi0z37Z1Wt1zKgL
# o+NiVMIsSg46tjf5SDDVunZ2Hb45OTuenDbKrU46cbwBjyLtENjMMb3Bq71Kf9Ou
# 7IOuQFrTkut09fRg/mV3m7erLp8LfayNWNyyjPKB6Fb1bL1+WrfZUFNfScB9rvQZ
# 9Ub2I1WII7P6Z0bT6yExsQaS1JLKi7VAgdYRNm/mWw1iCLDwSSu5Yj2svMng1nuF
# oWrGWygWbGmXpUQ5xyKj1ruPzezFX9miX+BKaK4QxjlqNydF85z5y2o6SoLOYJP2
# qaGCAyYwggMiBgkqhkiG9w0BCQYxggMTMIIDDwIBATB9MGkxCzAJBgNVBAYTAlVT
...
# KoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yNjAyMDYxMzQ0NTdaMC8GCSqGSIb3
# DQEJBDEiBCC/PT84dFYasbXUlzXRImD8tA3NVlNaKjqzyvlpt0RqqTANBgkqhkiG
# 9w0BAQEFAASCAgAzEOF+CCma4Ph51UBj2OtqiBeMCEGLQ1MyAjaaauZy343k4/GW
# jm757HyVbZ4a1Z4ZNVwUluhW5y4w23Vkf2zbh0WO89Inz7OPk4fF0pFFOR3sQUb2
# dR2vwtxsNChZwOMa++tbMIsjr8rbKzy3cpeZl2C3KlqAmZUlWn7L+SHvYg31++Zu
# DIDQJnspvqSE8wKaBUjowPNwW7N3DwoKOhF9DivOjPFmu/cxPrpor7KEupOIcw6a
# bnZjAoKLghQLPpEbIG9CpmFX1KrdkvMh4A5vO7p8urvcjNKxyBTNn+jkpic7nKmE
# v0hZzG9+wAUVLkqWzomtHKBJgxZFoM25AJqJuyEmZtiIWsk+5cMQe05c00S+E5ae
# KOXSlSWXhOgZ6NsweSoyDIS6bfSi+ZsnPG1h3fYrKvGe8wo2RKqWLcwFnFdKw01L
# E0wFfLbGKNlTtf1tdpfotpb/AW2OJfWhZ2VQA5/dwf2VH/hJQ2Ft5wJrf9ba9raT
# wFslFFuaEbO3Vv3XlV/uCSB8ivY9zTNrpJuBp3a/ZtRrz4rK0rfn59jWy5mx4Ooo
# L2PmgxDLzHlJtH9nYRWmhAG0fpEtCzm6n85ge1W2KT/xZLd7xgsP/6VwsEph8/mF
# BSXJoNDkbWAEZBZX8liWNbRqIJOEDHEj2Z+M0EtVn6bmsIWjbm21+Jol/w==

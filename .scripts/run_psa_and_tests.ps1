...
$files = Get-ChildItem -Path . -Include *.ps1,*.psm1 -Recurse -File -ErrorAction SilentlyContinue |
    Where-Object { $_.Name -notlike '*.bak.*' -and $_.FullName -notmatch '\.git' }
$results = @()
foreach($f in $files){
    try{
...
Write-Output 'Run complete. Reports: pssa-report.json (root)'

# SIG # Begin signature block
# MIIf3QYJKoZIhvcNAQcCoIIfzjCCH8oCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBSY6ylau5b0eLU
# dNZNx6uzH1uTVY9hssoCnto5x5qb5aCCGNwwggWNMIIEdaADAgECAhAOmxiO+dAt
...
# AgEVMC8GCSqGSIb3DQEJBDEiBCBRJGS6f5BhFXb/vWwIk/zKUBQQPAy25QlgU9jh
# 2SNHrDANBgkqhkiG9w0BAQEFAASCAgC4FmC02d+ynywNVRCoVJwGNOsii16UoYtD
# u9xaY1R19aRuIOf2C4jrsSn4zaKTdmkVIemqHiFMIguch1YInUoRRIDIdfGbWnK0
# WtfZzxxm/Ckf5lpm0u4w08eW91LGc6jyF196sb3n0gx9+4LGTRa8qY55F2gMRAoK
# pDdnRDhTZuc4Vfl+v7pyzEOiPJ1+m//oapS0Tp1EsPMvlJ6W2COJvMzmYHxRGfIr
# +UoPu1rFkB1JnkklIMZmzmkF9FnvKKQZg3Hi2U0ydIcsG8l6oEskkTrnUealXtMh
# F8jRCNDuyvai+Q5F/c9I8j0mqfsWI+gWfe2qOuu8Ldykm9pUNy7oVzUx6rGqvAvJ
# Chc48JHwL59jp2dDvnoWeLxiPjbJpfXUrodirnB/PnFNUrifRFoDPvggIISXdM9N
# yHIeYc8PJf1PPR/7urEx3T1d7RBS/vDEUegL8uwi7c+P5+WxpqKavH8w1Sy/4Ewm
# XvbWOVjuHew7W4Tzz0jT27Tk7SOJA0ofZ8gIrV7eO/Osiyhi+mmyGumrPL4dhe78
# lybtpMFa90RLmptZrD929tsKIiYPWenArOhcTvgLZqQw6+9bU0zK0Qoheuo2HUZ2
# xMDQ3+U+fVeG9aHUTxRXABXlKv6dKqw3oyFW5ZQ69ABF+6jMSS/HYuiBYun1xV3F
# dbb0xRfbbqGCAyYwggMiBgkqhkiG9w0BCQYxggMTMIIDDwIBATB9MGkxCzAJBgNV
...
# CSqGSIb3DQEJBDEiBCBpGxicpgYSQjcdXQTrtJegzCbWASoE9qTlXlEbzWpUwDAN
# BgkqhkiG9w0BAQEFAASCAgC3Bjo0VgewbC04I2vmneCS7GrHKocDjdCEX3tUs0os
# o+GGLLGazLAw4DHkpjrHRkyqJb0DGbpYFwJwvc3sUq5UC3ViZtDQeJmVSJi5NIM5
# ys/ZM//+Y+YjE0XG2ZGJGaQ8G1j/0a0mynCRCKclzPePg+6eitpNjK9jecyCTAWA
# zt8jd/+U6ViPql6gMm6V5YNpbAn7ZKfrI9uZO7f80o8T4tEWUQ4u1xLjpvdWMQeU
# +l9fVaCyITBlq1D0zYTDrHLRSAqL3o92lN7eqCsbiOSGaRJJ3bEve/q2pTB60RTC
# xdvbKhpc8DdneK0V29lN08IVl3ej1h0ZCumcXr08tA+lAhr4t4bGtvGYheqgRcxB
# 6odDx/gJ8DGZD76fAL//i0GHm3QdubvBbGOON3rBw4bbEvGtawBSpkm1lls25xL+
# +MR5Z/l1dpAjZ2Vqwdno6ay4BI4kos0cb1F1Yl1p47r1uW+pRh1HwcXUM/Iwn3YO
# okOz0eRBoqDiscNdysNUAKTn6N6LmAfGTjfSQV08+YNUSb2T2fO6FRb4rfhBdhzF
# ioxOhNsd91gnfKEJ6WZngk+jdm1FNzMaOcm3CCXXBufschRLDoDqy5j1ExW/Sj8S
# FzFrwUEF8NnDOC3k4RF/pBbGz+o7CEClmNfvw8mQ8ScNSwtEZaJRm2lk/M53YioC
# zw==

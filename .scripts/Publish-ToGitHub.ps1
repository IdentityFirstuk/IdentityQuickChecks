...
<#
.SYNOPSIS
    Publishes IdentityFirst QuickChecks to GitHub.

.DESCRIPTION
    This script stages, commits, and pushes all changes to the GitHub repository.

.PARAMETER CommitMessage
    Custom commit message. If not provided, auto-generates one.

.PARAMETER Push
    If specified, pushes to remote after commit.

.EXAMPLE
    .\.scripts\Publish-ToGitHub.ps1 -Push
#>
...
$repoPath = "d:/IdentityFirst-Ltd/web/2026web/powershell-modules"

Write-Host "=== GitHub Publish Script ===" -ForegroundColor Cyan
Write-Host ""
...
try {
    ...
    Write-Host "Git is not available. Please install Git." -ForegroundColor Red
    exit 1
}
...
# Get changed counts by type
$addedFiles = ($status | Where-Object { $_ -match '^A\s' }).Count
$modifiedFiles = ($status | Where-Object { $_ -match '^M\s' }).Count
Write-Host "  Added: $addedFiles" -ForegroundColor Green
Write-Host "  Modified: $modifiedFiles" -ForegroundColor Yellow

# Generate commit message if not provided
if ([string]::IsNullOrEmpty($CommitMessage)) {
    $date = Get-Date -Format "yyyy-MM-dd"
    $CommitMessage = "feat: Add 21 new read-only QuickChecks - $date

- Added 15 new read-only security checks across AD, Entra ID, AWS, GCP
- Enhanced existing checks with improved error handling
- Added PowerShell 5.1 and 7 compatibility fixes
- Updated module manifests with new function exports
- Added comprehensive code review documentation

Co-authored-by: Mark Ahearne <mark.ahearne@identityfirst.net>"
}
...
if ($Push) {
    ...
    if ($pushResult -match "error|fatal") {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDAqTIGU93cSSQf
# exoS8DRNcRst3lip84QibIMkMp1H56CCGNwwggWNMIIEdaADAgECAhAOmxiO+dAt
...
# AgEVMC8GCSqGSIb3DQEJBDEiBCD7NfQ33JEUkca6fai323rZRbrWX18TdJXCJ95R
# IOhUFzANBgkqhkiG9w0BAQEFAASCAgB8sssGAz6qY30JityrWm2WTfl9j4VFikSL
# 9HYF1xClULSpRKgtsUvVMLGHeXp6z2jDaCvWdVLKlCqS9FAYdiHj4Iur7nQVDYkK
# 8ZWXncZaT5NliaG241RbCcUQ52zg3Kx8uJ73JnXnxC0ePzUvviBe5bMeU7tIfHoJ
# 3yeARIko5zLCV2QE8CQ+uTWAp63FBf8BogkHIHtXtxtjUdUSOo3rRsXZgWwUtKhP
# FzASBiChxmsTNTjRnZzhMWm3CL4TLOEGuxVnGEvB0cSAFG3kQ7ur3T9xYcuvDent
# GvaGg5sqI8Qot/Op4Qow4F1ctWEkjMUOtw35EnaGLQplqPehRnv9XE9ztqI6uFNl
# oOxAmO43/KI+Vm92S2sVGx7tDKitYK8LXwl85pwi8pJPvWTBh3fi9LC/syPSb3Yf
# VJ1peBNNJfbilWMtL0aQ7kvUfTyzz4/bH6K3Oz8UXMJU7QrDUUZCnvZradOFnDLz
# OOkDWnJGyzK6yzfziPodLgIbv+RxiY0eyOynk35kcUqQf15WI9SvIn8lv+aPGJHc
# XfhzfOtU6rrW57pT7K43534maXwUtCVMfQrf6DXBtw85fEblSHHymvlnaNEevZB2
# xrMdaTG+cpan6GykqS0DWvYVX8MuopzK7I7MBbKYcm8Mmh99gyrsv8rgpm5ohvEI
# bBSTXSiXEKGCAyYwggMiBgkqhkiG9w0BCQYxggMTMIIDDwIBATB9MGkxCzAJBgNV
# BAYTAlVTMRcwFQYDVQQKEw5EaWdpQ2VydCwgSW5jLjFBMD8GA1UEAxM4RGlnaUNl
# cnQgVHJ1c3RlZCBHNCBUaW1lU3RhbXBpbmcgUlNBNDA5NiBTSEEyNTYgMjAyNSBD
# QTECEAqA7xhLjfEFgtHEdqeVdGgwDQYJYIZIAWUDBAIBBQCgaTAYBgkqhkiG9w0B
# CQMxCwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yNjAyMDUxNzEyNTZaMC8G
# CSqGSIb3DQEJBDEiBCBUSayah/M9D4Ex47O81jUt+KCUGczqrWGHQDoPADaXVzAN
# BgkqhkiG9w0BAQEFAASCAgC2My5UbEgu+45WSkqUK7G1BuRwEYURHuqbuEpZgWAt
# ceKb5w4lbNDL9W4Ac3rrt3E9kbuVVwgXQLgIrZ7mZSoh5xQ+v4s9rqgrqUPmj73H
# y2LnU+ysmCgN9iLCvC53UcTSLlvXaezkcLIjeipSKdokge1TL1Rfnz9aOsLXDkc9
# tesnXjXLOcSju7JhU1YEZgeRN86NBArTjAtzhM/NyL6mpEEhDtUAc2RlT+8s3RUI
# 2R2GCflayZ4rFWjWtXtH1UmjdRvRkgAmoXPveQxgfbKaUcxSFBNNCNx0w0Hra1Dt
# tVuu1PkBqnBNe94zHmtQS4W6H0ZOpc1FJhD6fD86hAK0rwXpgFfDFOqy8bifaOIp
# UTzeQrh4OEU4K62aqMduquYvXXhoY2Wv+oZf40h2uHN3qsxe+CsdoOHxWae/dL94
# Ukfz0GOO1+JVibAnI3UfzRMZVvkyooG/5E6ht6eIU3vMbHirMjBhbM4pwUhBF3oX
# gUp/pF4jN1LuIDNXP4y8k8COexfDNqiMYbapdiIx4fRn8L31neD1USOf8WRwZHje
# UmzK8KpvCYUAs4hh93I0av9GwJZyEz6ml+2elBmq/qOUSha7Keud67aCCVIZBlMf
# Ot5UUgTBPWyMIcvnC/8XMSpaUd5KfWD7hufiPR0uvLKBSIOffac2deL1/fk7QU02
# kw==

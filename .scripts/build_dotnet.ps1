...
# ============================================================================
param(
    [string]$ProjectPath = '.\\dotnet\\IdentityFirst.QuickChecks.Core',
    [string]$Configuration = 'Release'
)

Set-StrictMode -Version Latest

$fullProj = Resolve-Path $ProjectPath
if (-not (Test-Path $fullProj)) { Write-Error "Project path not found: $ProjectPath"; exit 2 }

Write-Output "Building .NET project: $fullProj"
pwsh -NoProfile -Command "dotnet build `"$fullProj`" -c $Configuration"
if ($LASTEXITCODE -ne 0) { Write-Error "dotnet build failed"; exit $LASTEXITCODE }

Write-Output "Build complete. Output located under bin\\$Configuration" 
# SIG # Begin signature block
# MIIf3QYJKoZIhvcNAQcCoIIfzjCCH8oCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDG/RWlac5zli2o
# IyOitiSVegOeX/G8kc2Q3oaYLlBpV6CCGNwwggWNMIIEdaADAgECAhAOmxiO+dAt
...
# AgEVMC8GCSqGSIb3DQEJBDEiBCCsTmPEVyu016zHYP2c8IYjLh6sz9vi3A2mlvo7
# YEYbDjANBgkqhkiG9w0BAQEFAASCAgBNLSvhcwyk7bH6Dgh1tkoqu8BvaBqUp0iJ
# f5FPmMbpKtbpQdgC/73CIV9Dj8kMLGV0wKupAcTmxQrsqplErw0XuHXMEKTQX83R
# EKWcq6Y1Eluwn7zQDwsSo1QgJ/t2RklMteaSUsdZuX52mYwb8fSN9jyMbd/0j4ZB
# BkLLhVf8uJOFJZpDiZe3o0JTyNNGoOZwAxUEjFYcWJbEnuk+xIqleODF6b379RyM
# i3gMPEygWsA+j4eW3yUt3t4q2arPegiZ69AVJ7kTUX02Ia0hZrE6E8/+ijsPjdAl
# Vp3RutFeKTFCKeuA9/6Nlfmh4mJUWVkS/c2s5Aar+fYvUoZdbMBga7NS5z2ZrnM1
# q7rSMLhhmjwT8GHb7CX3nXBgvPE2glmR3D72sV7fvSLvw4C120W4TigM/EgMijtW
# ca9XcACe1QQo0Mm0CE2y0WWNHp8ff6Ny7dABvkUC0jgaPG38OnzOweeb5vqJ5qhW
# 7D+AcrPmYrl1OSjGlXa7eWHRyUS2d0xsfN0+Jg5+TnftGRWQHiqiCC8RZmrPrY+V
# tVyK/3xlkMSvj11k5XVKApM1ufiwfht73TYbDLGGIg/yqVVBlCn8qvqAr670q2sH
# Wma7dAfo2wQFwt9lVe3OIG1HaxgWUeLxf3zzVgqsLEklTtjgWc8xB/dGSaQZJeQO
# vR2BjPkJYaGCAyYwggMiBgkqhkiG9w0BCQYxggMTMIIDDwIBATB9MGkxCzAJBgNV
...
# CSqGSIb3DQEJBDEiBCA/b7xGK4E2203RJ35tuzxuNU6vYQGVAu1qWDiOIdu5UzAN
# BgkqhkiG9w0BAQEFAASCAgAyUL38GMy9fq2/90RmMXYyW6pqdrCGHT3O2dJkrKCe
# TaFe968IFll4aQf0cSWpM/c241FxA2F5GdlQeZQE+X2ertQN6yc/Bt8iyBzPlSoC
# MItwRHu+ZXJMmj21y6FjN2K4lqiFfj9PD9x31xKWK4IwwfPLOCnvNzfBrk5Hvtzj
# qb+ys7MtqX8jga4LFwXsZMJ4nAtIhQCLd8xLinUNyF1CkyeAtnHL8cPpevgcLOdh
# UCSMrBcVSXyZuV03TQmz5+4sIkxk2iupMC9A5ZZ7yfOuDaKuhyHfZ5Ljou8qc/i9
# UKGCm6wrM0k0cZfX0kYzugPhwbeQM3lGBKFnt+Ti4ZtsRXtBE/Dd4BErUshtxaGN
# QkMVt2o7JGYZUn5S67niIOO3weOeNrpA4IvvQeno/2oTJQRvR1C1KSXCoUlbBWqY
# ovfbPzjTnWoQSqyHycuILhkEpm/u4lLdzeMxvYhGNkp1jt9HeiTlaoHDpcHdIkm1
# 4kHVCgC0ighuCrKsWxa/JyT/tO6VuEJDeHT2uwY6kFHHvwIYIouJpUFjgH7rq9k2
# Ir45QcxK2r/ojni1QYs2HmpDmv9iPkbyQBd/FF1tju8A0HLwYq0pL/urjeuICyUh
# 9QRuHoT5+pgH7zcvcmt/owQ09hP5zdlHNFE2f0NR0XwrNJDlSBqNxd1Ul/HC3EuD
# Hw==

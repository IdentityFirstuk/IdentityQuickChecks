...
# ============================================================================
<#
STUB: apply_safe_fixes (moved)

This utility has been moved to `dev-tools/privileged/apply_safe_fixes.ps1`.
The copy present here is intentionally disabled in the free distribution to prevent
accidental modification of repository files. Maintainers with access to the
privileged toolkit may run the full fixer under controlled conditions.
#>

Write-Output 'apply_safe_fixes has been moved to dev-tools/privileged/apply_safe_fixes.ps1'
Write-Output 'To request privileged fixer access, contact the repository maintainers.'
exit 2
# SIG # Begin signature block
# MIIf3QYJKoZIhvcNAQcCoIIfzjCCH8oCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBbzw368Ax3ZlKY
# TR/H0vPoTuSmt1b/w6kPNlESmolLQKCCGNwwggWNMIIEdaADAgECAhAOmxiO+dAt
...
# AgEVMC8GCSqGSIb3DQEJBDEiBCAzz0LbrR26v4tXakk531FhkC0BzzkwzoG7AHeE
# tM282jANBgkqhkiG9w0BAQEFAASCAgCEs8hGu3O08OHs89ebrDio74hyqOXe24PI
# V8eX/quE+/25qCN3XNd4uqnlRO1Js/M2jhmqewLISnmSce5aNXOHYDdiXiuGQXxJ
# zTUscSyAGqm4avukDUJ+gp6uRCn5sv9kDXTAkzBuPn8H9t2+ArBL285H+Y9bnCBo
# e9qhWGsjcACm2yg4Q6N4DmxHIP9NH4aHBbT9uoLUgs8rprZ4qiw5Rx6zKJAqRvin
# /ImgVdlcpWU5D+pOtdWgn4aKusRxMUTD2pbDb+ZrZnW+nyvo6jXRFSP9O8BnbvdZ
# NAThA50s0zoH66Qm4H0T1EWVytSPCP5NUgW8wkdx72IoW4ndFd62FXyq59+bsntG
# FMJyHqDaOVn6m6cDoSyyDrwJMABULp4BLciMh+clLJ6sjaNvAlOnesd3rKz0wWL+
# IRjFj2YcMGSVhfL0kLjcfvaylocI8y02lV0NRfZK+DYD4j6WlcVSIOJ3M9H+OopI
# wNhauuPY+k0BQbDfEMTqSV8cylnHrajn4ympJu9qOBTq4hHgFTAi+5WiAkJcvVc5
# B8zvhnqpTHKUluDCRyg2a8n+brxAjSb9tmvbIQT7Y07XbIAqkJlIbeJ3+XGKflCS
# PO9ZHM1BW/SVsGQOrSQaZoUbjiOIEi8yxBlucYZDMzl9hruDMks8NV1Ti6tvfBzM
# GlcPnotB/KGCAyYwggMiBgkqhkiG9w0BCQYxggMTMIIDDwIBATB9MGkxCzAJBgNV
# BAYTAlVTMRcwFQYDVQQKEw5EaWdpQ2VydCwgSW5jLjFBMD8GA1UEAxM4RGlnaUNl
# cnQgVHJ1c3RlZCBHNCBUaW1lU3RhbXBpbmcgUlNBNDA5NiBTSEEyNTYgMjAyNSBD
# QTECEAqA7xhLjfEFgtHEdqeVdGgwDQYJYIZIAWUDBAIBBQCgaTAYBgkqhkiG9w0B
# CQMxCwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yNjAyMDUxNzEyNTRaMC8G
# CSqGSIb3DQEJBDEiBCBLjb0T5JMfS+gYey/LKLueLPLNvTL3sIBnHYzLLljNhzAN
# BgkqhkiG9w0BAQEFAASCAgANvVeve8J5rTnYsswG2C+K41AkQeb9HA2Eg+wgGQgO
# 8mzekI1eXs8xwqV8l8enjLsDVgosYcqA/v/C7udoKzDXKW4Tfjh4Cf5SphtPGjCj
# 67K8gJxTYEUZfAuwv1y2fXfy8ntjMv7BgMEVMs/t5ucyd1chZBWOQ3Gf54eyN5f0
# 0wTcUQRWbjzilX1lEAai/vmerJzgB+5OVzxfnRAm0d0b9e3qErgB83Y+jGHG6wmj
# xRKgWIXkJuSgEkXhP/NLkvDncfcMTN6D5JKWNkiszJcj3/xV88Af/1mYMr0SZlSQ
# ahg0ImmVXALfkaEjVGhPRs6hTRgOul4kWqwt/FawG4qGapPNTSssIKB4ZxlkOYZm
# CIvH1zOe2cVBx+5MfhCrgQTRdQZ3GEJ+oiOlYYhINnMyef0oRXilz88+9ekDLjjN
# eOeOiC4+PbPkg+sLRY5cuCObWkrYphUIzQUzWnM8jSvf1Tbu2tF5yxahXY6gv9yN
# b/74x1n8sw02E2GD1UhDlWyIzFjQRmO9IpZsTeSoGk6PvlInF71SQHIA+rqxiRo8
# xGGiv1lZ0VA2ZZlb3Q/+kmcGDfpUqggq0x2PUOUKiZqTi8J8SLrCAOlqmolk5BRJ
# 65/CTthvDJnLrubdUUFxrXBsyjlrTEADP4szVJm17Q1qC4Byinzy+KyczEihEgSt
# 0w==
